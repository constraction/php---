<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:68:"F:\phpStudy\WWW\tp5.0.24\public/../apps/index\view\reg\register.html";i:1562556066;}*/ ?>
<!DOCTYPE html>
<html>
	<head>
		<meta charset="UTF-8">
			...
			<div class="regist_center">
				...
				<div class="regist_main center">
					...
					<div class="username">
						...
						<div class="right fl"><img src="/static/index/img/yanzhengma.jpg"></div>
						<div class="clear"></div>
					</div>
				</div>
